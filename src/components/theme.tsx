...
// Definición de tipos para el esquema de colores
type ColorScheme = {
  [key: number]: string;
};
...
type ColorTokens = {
  grey: ColorScheme;
  primary: ColorScheme;
  greenAccent: ColorScheme;
  redAccent: ColorScheme;
  blueAccent: ColorScheme;
};

// Agregando tipos a la función `tokens`
...
// Agregando tipos a la función `themeSettings`
type ThemeSettings = {
  palette: {
    mode: "light" | "dark";
    primary: { main: string };
...
// Agregando tipos para el contexto
export const ColorModeContext: Context<{
  toggleColorMode: () => void;
}> = createContext({
  toggleColorMode: () => {},
});

// Tipos para el hook `useMode`
